...
public final class LibraryLoader
{
	...
	public static boolean loadLibrary()
	{
		...
		String launcher = LibraryLoader.class.getResource("LibraryLoader.class").toString();
		
		//Control flow
		boolean isSuccessful = false;

		if (launcher.startsWith("file"))
		{
		...
		else if (launcher.startsWith("jar") || launcher.startsWith("rsrc"))
		{
			//Path to library
			String libraryPath;
